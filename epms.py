...
class EmployeeSystem:
    def __init__(self,root):
        ...
        title=tk.Label(self.root,text="Employee Payroll Management System",font=("times new roman",30,"bold"),
                       bg="#292826",fg="white",anchor="w",padx=10)
        title.place(x=0,y=0,relwidth=1)
        button_emp=tk.Button(self.root,text="All Employees",command=self.employee_frame,font=("times new roman",13),
                             bg="#292826",fg="white",activebackground="#F9D342")
        button_emp.place(x=1050,y=10,height=30,width=140)
        button_logout=tk.Button(self.root,text="Log Out",command=self.logout,font=("times new roman",13),
                                bg="#292826",fg="white",activebackground="#F9D342")
        ...
        title2=tk.Label(Frame1,text="Employee Details",font=("times new roman",20),bg="#292826",
                        fg="#F9D342",anchor="w",padx=10)
        ...
        self.txt_code=tk.Entry(Frame1,font=("times  new roman",13),textvariable=self.var_emp_code,
                               bg="#292826",fg="White")
        self.txt_code.place(x=250,y=74,width=200)
        button_search=tk.Button(Frame1,text="Search",command=self.search,font=("times new roman",18),
                                bg="#292826",fg="#F9D342",activebackground="#F9D342")
        ...
        txt_designation=tk.Entry(Frame1,font=("times  new roman",13),textvariable=self.var_designation,
                                 bg="#292826",fg="White")
        ...
        txt_experience=tk.Entry(Frame1,font=("times  new roman",13),textvariable=self.var_experience,
                                bg="#292826",fg="White")
        ...
        combo_gender=ttk.Combobox(Frame1,textvariable=self.var_gender,font=('times new roman',13,'bold'),
                                  state="readonly")
        ...
        txt_hired=tk.Entry(Frame1,font=("times  new roman",13),textvariable=self.var_hr_location,
                           bg="#292826",fg="White")
        ...
        title3=tk.Label(Frame2,text="Employee Salary Details",font=("times new roman",20),
                        bg="#292826",fg="#F9D342",anchor="w",padx=10)
        ...
        txt_conveyance=tk.Entry(Frame2,font=("times  new roman",13),textvariable=self.var_conveyance,
                                bg="#292826",fg="White")
        ...
        txt_netsalary=tk.Entry(Frame2,font=("times  new roman",13),textvariable=self.var_n_salary,
                               bg="#292826",fg="White")
        txt_netsalary.place(x=440,y=225,width=120)
        
        ##--------Buttons----------##
        button_calculate=tk.Button(Frame2,text="Calculate",command=self.calculate,font=("times new roman",18),
                                   bg="#292826",fg="White",activebackground="#F9D342")
        button_calculate.place(x=100,y=275,height=30,width=120)
        
        self.button_save=tk.Button(Frame2,text="Save",command=self.add,font=("times new roman",18),bg="#292826",
                                   fg="white",activebackground="#F9D342")
        self.button_save.place(x=230,y=255,height=30,width=120)
        
        button_clear=tk.Button(Frame2,text="Clear",command=self.clear,font=("times new roman",18),bg="#292826",
                               fg="White",activebackground="#F9D342")
        button_clear.place(x=360,y=255,height=30,width=120)
        
        self.button_update=tk.Button(Frame2,text="Update",state=tk.DISABLED,command=self.update,
                                     font=("times new roman",18),bg="#292826",fg="white",activebackground="#F9D342")
        self.button_update.place(x=230,y=295,height=30,width=120)
        
        self.button_delete=tk.Button(Frame2,text="Delete",state=tk.DISABLED,command=self.delete,
                                     font=("times new roman",18),bg="#292826",fg="White",activebackground="#F9D342")
        ...
        txt_result=tk.Entry(cal_frame,bg='#292826',fg="White",textvariable=self.var_txt,
                            font=("times new roman",20,"bold"),justify=tk.RIGHT)
        txt_result.place(x=0,y=0,relwidth=1,height=50)
        
        #-----------------------Row 1-------------------#
        btn_7=tk.Button(cal_frame,text='7',command=lambda:btn_click(7),font=("times new roman",15,"bold"),bg="#292826",
                        fg="#F9D342",activebackground="#F9D342")
        btn_7.place(x=0,y=52,w=60,h=60)
        btn_8=tk.Button(cal_frame,text='8',command=lambda:btn_click(8),font=("times new roman",15,"bold"),bg="#292826",
                        fg="#F9D342",activebackground="#F9D342")
        btn_8.place(x=61,y=52,w=60,h=60)
        btn_9=tk.Button(cal_frame,text='9',command=lambda:btn_click(9),font=("times new roman",15,"bold"),bg="#292826",
                        fg="#F9D342",activebackground="#F9D342")
        btn_9.place(x=122,y=52,w=60,h=60)
        btn_divide=tk.Button(cal_frame,text='/',command=lambda:btn_click("/"),font=("times new roman",15,"bold"),
                             bg="#292826",fg="#F9D342",activebackground="#F9D342")
        btn_divide.place(x=183,y=52,w=60,h=60)
        
        #-----------------------Row 2-------------------#
        btn_4=tk.Button(cal_frame,text='4',command=lambda:btn_click(4),font=("times new roman",15,"bold"),bg="#292826",
                        fg="#F9D342",activebackground="#F9D342")
        btn_4.place(x=0,y=112,w=60,h=60)
        btn_5=tk.Button(cal_frame,text='5',command=lambda:btn_click(5),font=("times new roman",15,"bold"),bg="#292826",
                        fg="#F9D342",activebackground="#F9D342")
        btn_5.place(x=61,y=112,w=60,h=60)
        btn_6=tk.Button(cal_frame,text='6',command=lambda:btn_click(6),font=("times new roman",15,"bold"),bg="#292826",
                        fg="#F9D342",activebackground="#F9D342")
        btn_6.place(x=122,y=112,w=60,h=60)
        btn_multiply=tk.Button(cal_frame,text='*',command=lambda:btn_click("*"),font=("times new roman",15,"bold"),
                               bg="#292826",fg="#F9D342",activebackground="#F9D342")
        btn_multiply.place(x=183,y=112,w=60,h=60)
        
        #-----------------------Row 3-------------------#
        btn_1=tk.Button(cal_frame,text='1',command=lambda:btn_click(1),font=("times new roman",15,"bold"),bg="#292826",
                        fg="#F9D342",activebackground="#F9D342")
        btn_1.place(x=0,y=172,w=60,h=60)
        btn_2=tk.Button(cal_frame,text='2',command=lambda:btn_click(2),font=("times new roman",15,"bold"),bg="#292826",
                        fg="#F9D342",activebackground="#F9D342")
        btn_2.place(x=61,y=172,w=60,h=60)
        btn_3=tk.Button(cal_frame,text='3',command=lambda:btn_click(3),font=("times new roman",15,"bold"),bg="#292826",
                        fg="#F9D342",activebackground="#F9D342")
        btn_3.place(x=122,y=172,w=60,h=60)
        btn_minus=tk.Button(cal_frame,text='-',command=lambda:btn_click("-"),font=("times new roman",15,"bold"),
                            bg="#292826",fg="#F9D342",activebackground="#F9D342")
        btn_minus.place(x=183,y=172,w=60,h=60)
        
        #-----------------------Row 4-------------------#
        btn_0=tk.Button(cal_frame,text='0',command=lambda:btn_click(0),font=("times new roman",15,"bold"),bg="#292826",
                        fg="#F9D342",activebackground="#F9D342")
        btn_0.place(x=0,y=233,w=60,h=60)
        btn_clear=tk.Button(cal_frame,text='C',command=clear_calc,font=("times new roman",15,"bold"),bg="#292826",
                            fg="#F9D342",activebackground="#F9D342")
        btn_clear.place(x=61,y=233,w=60,h=60)
        btn_plus=tk.Button(cal_frame,text='+',command=lambda:btn_click("+"),font=("times new roman",15,"bold"),
                           bg="#292826",fg="#F9D342",activebackground="#F9D342")
        btn_plus.place(x=122,y=233,w=60,h=60)
        btn_equalto=tk.Button(cal_frame,text='=',command=result,font=("times new roman",15,"bold"),bg="#292826",
                              fg="#F9D342",activebackground="#F9D342")
        ...
        title_sal=tk.Label(sal_frame,text="Salary Receipt",font=("times new roman",20),
                           bg="#292826",fg="#F9D342",anchor="w",padx=10)
        ...
        self.sample=f'''Company Name: S.M.S pvt ltd\nAddress: U.P,India
--------------------------------------------------------
 Employee ID\t\t:  
 Salary of\t\t:  Mon-YYYY
...
'''
        ...
        self.txt_salary_receipt=tk.Text(sal_frame2,font=("times new roman",11),bg="#292826",fg="White",
        ...
        self.button_print=tk.Button(sal_frame,text="Print",command=self.print,state=tk.DISABLED,
                                    font=("times new roman",18),bg="#292826",fg="White",activebackground="#F9D342")
    ...
    def add(self):
        if self.var_emp_code.get()=='' or self.var_email.get()=='' or self.var_name.get()=='' or \
            ...
            try:
                ...
                if row!=None:
                    ...
                    cur.execute("insert into emp_salary values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,"
                                "%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                                (self.var_emp_code.get(),self.var_designation.get(),self.var_name.get(),
                                 self.var_age.get(),self.var_gender.get(),self.var_email.get(),
                                 self.var_hr_location.get(),self.var_dob.get(),self.var_doj.get(),
                                 self.var_experience.get(),self.var_proofid.get(),self.var_contact.get(),
                                 self.var_status.get(),self.txt_address.get('1.0',tk.END),self.var_month.get(),
                                 self.var_year.get(),self.var_b_salary.get(),self.var_t_days.get(),
                                 self.var_absents.get(),self.var_medical.get(),self.var_pf.get(),
                                 self.var_conveyance.get(),self.var_n_salary.get(),self.var_emp_code.get()+".txt"))
                    con.commit()
                    con.close()
            ...
            try:
                ...
                if row==None:
                    ...
                    cur.execute("UPDATE `emp_salary` SET `designation`=%s,`name`=%s,`age`=%s,`gender`=%s,`email`=%s,"
                                "`hr_location`=%s,`dob`=%s,`doj`=%s,`experience`=%s,`proof_id`=%s,`contact`=%s,`status`=%s,"
                                "`address`=%s,`month`=%s,`year`=%s,`basic_salary`=%s,`t_days`=%s,`absent_days`=%s,`medical`=%s,"
                                "`pf`=%s,`conveyance`=%s,`net_salary`=%s,`salary_receipt`=%s WHERE `e_id`=%s",
                                (self.var_designation.get(),self.var_name.get(),self.var_age.get(),self.var_gender.get(),
                                 self.var_email.get(),self.var_hr_location.get(),self.var_dob.get(),self.var_doj.get(),
                                 self.var_experience.get(),self.var_proofid.get(),self.var_contact.get(),self.var_status.get(),
                                 self.txt_address.get('1.0',tk.END),self.var_month.get(),self.var_year.get(),self.var_b_salary.get(),
                                 self.var_t_days.get(),self.var_absents.get(),self.var_medical.get(),self.var_pf.get(),self.var_conveyance.get(),
                                 self.var_n_salary.get(),self.var_emp_code.get()+".txt",self.var_emp_code.get()))
                    con.commit()
                    con.close()
                    file=open('receipts/'+str(self.var_emp_code.get())+".txt",'w')
                    file.write(self.txt_salary_receipt.get('1.0',tk.END))
    ...
    def calculate(self):
        if self.var_month.get()=='' or self.var_year.get()=='' or self.var_b_salary.get()=='' or self.var_absents.get()=='' or\
                self.var_t_days.get()=='' or self.var_medical.get()=='' or self.var_pf.get()=='' or self.var_conveyance.get()=='':
            ...
            #####Update Receipt####
            new_sample=f'''Company Name: S.M.S pvt ltd\nAddress: U.P,India
--------------------------------------------------------
...
'''         
    ...
    def employee_frame(self):
        ...
        title=tk.Label(self.root2,text="All Employee Details",font=("times new roman",30,"bold"),
                       bg="#292826",fg="#F9D342",anchor="w",padx=10)
        ...
        self.employee_tree=ttk.Treeview(self.root2,columns=('e_id', 'designation', 'name', 'age', 'gender', 'email',
                                                            'hr_location', 'dob', 'doj', 'experience', 'proof_id', 'contact',
                                                            'status', 'address', 'month', 'year', 'basic_salary', 't_days', 'absent_days',
                                                            'medical', 'pf', 'conveyance', 'net_salary', 'salary_receipt'),
        ...
        self.employee_tree.column('t_days',width=70)
